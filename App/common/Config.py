...
wow_talent_link = {
    'cl2':{'cl2-1': '神圣', 'cl2-2': '防护', 'cl2-3': '惩戒'},
    'cl11':{'cl11-1': '平衡', 'cl11-2': '野性', 'cl11-3': '守护','cl11-4': '恢复'},
    'cl12':{'cl12-1': '浩劫', 'cl12-2': '复仇'},
    'cl1':{'cl1-1': '武器', 'cl1-2': '狂怒', 'cl1-3': '防护'},
    'cl9':{'cl9-1': '痛苦', 'cl9-2': '恶魔学识', 'cl9-3': '毁灭'},
    'cl10':{'cl10-1': '酒仙', 'cl10-2': '织雾', 'cl10-3': '踏风'},
    'cl6':{'cl6-1': '鲜血', 'cl6-2': '冰霜', 'cl6-3': '邪恶'},
    'cl8':{'cl8-1': '奥数', 'cl8-2': '火焰', 'cl8-3': '冰霜'},
    'cl4':{'cl4-1': '奇袭', 'cl4-2': '狂徒', 'cl4-3': '敏锐'},
    'cl5':{'cl5-1': '戒律', 'cl5-2': '神圣', 'cl5-3': '暗影'},
    'cl3':{'cl3-1': '野兽控制', 'cl3-2': '射击', 'cl3-3': '生存'},
    'cl7':{'cl7-1': '元素', 'cl7-2': '增强', 'cl7-3': '恢复'},
    'cl13':{'cl13-1': '湮灭', 'cl13-2': '恩护', 'cl13-3': '增辉'}
}
wow_talent = {
